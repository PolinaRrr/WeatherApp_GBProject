...
fun getWorldCities(): List<WeatherInfo> {
    return listOf(
        WeatherInfo(City("London", 51.5085300, -0.1257400),
            1,
            2,
            "Cloudy",
            3,
            "north",
            761),
        WeatherInfo(City("Tokyo", 35.6895000, 139.6917100),
            3,
            4,
            "Cloudy",
            3,
            "north",
            761),
        WeatherInfo(City("Paris", 48.8534100, 2.3488000),
            5,
            6,
            "Cloudy",
            3,
        ...
        WeatherInfo(City("Roma", 41.9027835, 12.496365500000024),
            9,
            10,
            "Cloudy",
            3,
        ...
        WeatherInfo(City("Kyiv", 50.4501, 30.523400000000038),
            17,
            18,
            "Cloudy",
            3,
...
fun getRussianCities(): List<WeatherInfo> {
    return listOf(
        WeatherInfo(City("Moscow", 55.755826, 37.617299900000035),
            1,
            2,
            "Cloudy",
            3,
        ...
        WeatherInfo(City("Chelyabinsk", 55.1644419, 61.4368432),
            13,
            14,
            "Cloudy",
            3,
            "north",
            761),
        WeatherInfo(City("Omsk", 54.9884804, 73.32423610000001),
            15,
            16,
            "Cloudy",
            3,
        ...
        WeatherInfo(City("Ufa", 54.7387621, 55.972055400000045),
            19,
            20,
            "Cloudy",
            3,
